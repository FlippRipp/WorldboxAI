...
The `action_rating_strictness` slider (1-10) shifts judgment within the rubric. Each value is a named difficulty tier — 1 Power Fantasy, 2 Cinematic, 3 Heroic, 4 Favorable, 5 Balanced, 6 Gritty, 7 Demanding, 8 Harsh, 9 Merciless, 10 Brutal — and the judge is prompted with only the chosen tier's label and guidance (never the 1-10 scale). No tier turns a merely unlikely action into a 1-2.
