...
Propose exactly 10 skill categories - BROAD domains of ability this character could plausibly begin learning in this world and at this point in the story. Each category is a wide umbrella that could hold dozens of very different skills (think "Combat", "Wilderness", "Arcane Arts", "Subterfuge", "Craft & Trade" - broad strokes fitting THIS world and character, never narrow specialties like "dagger throwing" or "rose gardening"). The 10 must be meaningfully different from each other and together should span most of what anyone could learn in this world. Favor a mix: some that extend what the character already does, some that open new ground the story has hinted at. Each has a name of 1-3 words and one short clause summary.
