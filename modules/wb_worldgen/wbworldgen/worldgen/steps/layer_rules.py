...
class LayerRulesStep(Step):
    ...
    guidance = _GUIDANCE
    schema = {
        "layer_rules": {"type": "list", "label": "Per-Layer Rules", "rerollable": True, "item_schema": {
            "layer_id": {"type": "string", "label": "Layer ID"},
            "name": {"type": "string", "label": "Layer Name"},
            "rules": {"type": "list", "label": "Rules", "item_type": "string"},
        }},
        "world_rules": {"type": "list", "label": "Remaining World Rules", "item_type": "string", "rerollable": True, "description": "Rules that apply globally. Layer-specific rules moved to layer_rules."},
    }
