...
from wbworldgen.worldgen.base import (
    Step,
    STEP_REGISTRY,
    USES_ENRICHMENT,
    USES_LLM,
...
from wbworldgen.worldgen.facade import WorldBuilder
from wbworldgen.worldgen.types import (
    PipelineStep,
    StepContext,
    StepResult,
    WorldState,
...
def register_default_steps(world_builder: "WorldBuilder") -> "WorldBuilder":
    ...
    Importing ``wbworldgen.worldgen.steps`` triggers ``@register`` on every
